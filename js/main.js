...
$(window).load(function() {
    ...
    var n = "#EC008C";
    $("#minimos-4").length && (n = "#F8EB31"),
    $("#drifter").length ? initDrifter("drifter", n) : $("#particles-js").length && initStompParticles();
    var o = $(".st-countdown");
    ...
    var a, t, s = $(".main-content p_BK"), r = $(".main-content h3"), i = $(".main-content ul"), c = "20px", l = new TimelineMax({
        paused: !0,
        delay: .05,
        onComplete: function() {
    ...
    isFirefox ? c = "0px" : mobileVar && (c = "2px"),
    o.countdown("pause"),
    r.length && (t = new SplitText(r,{
        type: "words,chars",
